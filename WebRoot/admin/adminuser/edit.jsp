...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminUsers_update.action" method="post" enctype="multipart/form-data">
