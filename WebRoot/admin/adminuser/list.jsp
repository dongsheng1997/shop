	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function delOne(uid){
				...
				if(sure){
					window.location.href="${pageContext.request.contextPath}/adminUsers_delete.action?uid="+uid;
				}
			}
		</script>
	</HEAD>
								...
								<s:iterator var="c" value="cList" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminUsers_edit.action?uid=<s:property value="#c.uid"/>">
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<a href="javascript:delOne(<s:property value="#c.uid"/>)">
