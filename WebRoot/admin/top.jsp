								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="170" valign="bottom"
											...
											<a href="${pageContext.request.contextPath}/adminUserUpdate_editPassword.action?uid=<s:property value="#session.existAdminUser.uid"/>" target="mainFrame">
											修改密码
											</a>
											</s:if>
											
											<s:if test="#session.existAdminUser != null">
											<a href="${pageContext.request.contextPath}/adminUserUpdate_quit.action" target="_blank">
											安全退出
											</a>
											</s:if>
										</td>
