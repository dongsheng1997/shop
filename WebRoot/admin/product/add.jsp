		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_save.action" method="post" enctype="multipart/form-data" onsubmit="return check()">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="market_price" value="" class="bg" id="a"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商品商城价格:
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="shop_price" value="" class="bg" id="b"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="number" value="" class="bg" id="c"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<textarea rows="5" cols="20" name="pdesc"></textarea>
					</td>
				</tr>
				<tr>
