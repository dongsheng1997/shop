...
<script>
	...
	function change(){
		...
		img1.src="${pageContext.request.contextPath}/checkImg.action?"+new Date().getTime();/* 清除缓存 加时间戳 */
	}
</script>
</head>
<body>
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<span><s:fielderror fieldName="password"/><!-- 错误数据，回显 --></span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									...
									<span><s:fielderror fieldName="email"/><!-- 错误数据，回显 --></span>
								</td>
							</tr>
									<tr>
										<th>
										...
										<td>
												...
												<span><s:fielderror fieldName="name"/><!-- 错误数据，回显 --></span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
												...
												<span><s:fielderror fieldName="addr"/><!-- 错误数据，回显 --></span>
										</td>
									</tr>
								<tr>
									<th>
