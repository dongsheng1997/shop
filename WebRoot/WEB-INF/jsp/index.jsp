...
<!-- 					<div class="hotProductAd">
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
									<s:iterator var="p" value="hList"> <!-- 值栈 不需要加#号 -->
										<li>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
						 			<s:iterator var="p" value="nList"><!-- 值栈 不需要加#号 -->
									<li>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright"><a href="${pageContext.request.contextPath }/admin/index.jsp"><font color="red"><button class="buttton">管理员登录</button></font></a></div>
	</div>
</div>
</body>
</html>