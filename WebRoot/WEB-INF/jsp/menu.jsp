...
<div class="span10 last">
	<div class="topNav clearfix">
		<ul>
			<!-- 没有登陆 -->
			<s:if test="#session.existUser == null"><!-- ongl表达式 取出session的值判断是否为空 -->
			...
			<s:else>
				...
				|</li>
				<li id="headerRegister" class="headerRegister"
					style="display: list-item;"><a href="${pageContext.request.contextPath }/user_quit.action">退出</a>|</li>	
			</s:else>
			
			<li><a href="${pageContext.request.contextPath }/user_associator.action">会员中心</a> |</li>
			<li><a>购物指南</a> |</li>
			<li><a href="${pageContext.request.contextPath }/user_about.action">关于我们</a></li>
		</ul>
	</div>
	<div class="cart">
